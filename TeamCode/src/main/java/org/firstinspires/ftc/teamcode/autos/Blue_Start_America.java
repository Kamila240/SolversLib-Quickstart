...
@Autonomous(name = "Blue_Start_America", group = "Autonomous")
public class Blue_Start_America extends OpMode {
    ...
    private AutoState autoState = AutoState.CYCLE1_GRAB;
    ...
    private final Pose pickup3Pose = new Pose(6.827257817682839, 46.88202862352627, Math.toRadians(95));
    ...
    private final Pose pickup5Pose = new Pose(6.832554517133957, 46.946261682243005, Math.toRadians(95));
    ...
    private final Pose leavePose = new Pose(9.43312861373366, 8.499874971412602, Math.toRadians(180));
    ...
    public void init() {
        ...
        autoState = AutoState.CYCLE1_GRAB;
        autoAimEnabled = true;
