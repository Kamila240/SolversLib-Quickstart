...
import org.firstinspires.ftc.teamcode.commands.AutoAimTurretCommand_goal_Blue;
...
@TeleOp(name = "America is BLUE")
public class America_Blue extends CommandOpMode {

    private PedroDriveSubsystem drive;
    private TurretSubsystem_goal turret;
    private ShooterSubsystem shooter;

    private AutoAimTurretCommand_goal_Blue autoAimCommand;
    ...
    public void initialize() {
        ...
        drive = new PedroDriveSubsystem(
                hardwareMap,
                telemetry,
                new Pose(15.22073152115273, 76.99794448741913, Math.toRadians(180)) //new Pose(134.24376947040497, 8.661214953271044, Math.toRadians(90))
        );
        ...
        autoAimCommand = new AutoAimTurretCommand_goal_Blue(turret, drive);
