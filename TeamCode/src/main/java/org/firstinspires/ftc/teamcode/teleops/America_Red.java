...
@TeleOp(name = "America RED")
public class America_Red extends CommandOpMode {
    ...
    public void initialize() {
        ...
        drive = new PedroDriveSubsystem(
                hardwareMap,
                telemetry,
                new Pose(126.08443868626176, 76.55713451857179, Math.toRadians(0))  //new Pose(7, 8, Math.toRadians(90))
        );
