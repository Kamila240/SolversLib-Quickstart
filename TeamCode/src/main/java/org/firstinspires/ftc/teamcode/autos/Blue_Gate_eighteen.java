...
public class Blue_Gate_eighteen extends OpMode {
    ...
    private final Pose startPose = new Pose(16.513239875389402, 112.69236760124609, Math.toRadians(180));
    private final Pose scorePose = new Pose(45.105578290500006, 86.47714584743947, Math.toRadians(180));
    private final Pose pickup1Pose = new Pose(24.85965999973139, 80.4903900994342, Math.toRadians(180));
    private final Pose pickup1controlPose = new Pose(40.774922118380076, 77.36214953271029);
    private final Pose score1Pose = new Pose(48.47433360927437, 82.43821379068126, Math.toRadians(210));
    private final Pose pickup2Pose = new Pose(21.815438289127513, 57.67703632963949, Math.toRadians(180));
    private final Pose pickup2controlPose = new Pose(40.45913828564957, 52.290491103774066);
    private final Pose openGatePose = new Pose(17.57977969854801, 64.98237987296167, Math.toRadians(180));
    //private final Pose openGatecontrolPose = new Pose(116.51267137999399, 67.26428754055293);
    private final Pose score2Pose = new Pose(48.620963142067964, 82.42586277449269, Math.toRadians(225));
    private final Pose pickup3Pose = new Pose(21.095935484606272, 61.95750190594276, Math.toRadians(160));
    private final Pose pickup3controlPose = new Pose(31.646221899006875, 65.47750788538909);
    private final Pose gate1Pose = new Pose(12.900000000000006, 51.04497350288995, Math.toRadians(155));
    private final Pose gate1controlPose = new Pose(17.991415405992427, 51.24422835862195);
    private final Pose score3Pose = new Pose(48.47759081753354, 82.33744941176933, Math.toRadians(225));
    private final Pose score3controlPose = new Pose(32.67406550236262, 63.25040148848227);
    private final Pose pickup4Pose = new Pose(21.176754295038677, 62.01188302960525, Math.toRadians(160));
    private final Pose pickup4controlPose = new Pose(31.623122712049366, 65.4686693359521);
    private final Pose gate2Pose = new Pose(12.849037313490612, 50.92225011864848, Math.toRadians(155));
    private final Pose gate2controlPose = new Pose(17.996540664077784, 51.29572701026395);
    private final Pose score4Pose = new Pose(48.523739524807965, 82.42240836522713, Math.toRadians(225));
    private final Pose score4controlPose = new Pose(32.67003327896239, 63.27240712355774);
    private final Pose pickup5Pose = new Pose(15.19814440153256, 32.48767472616137, Math.toRadians(155));
    private final Pose pickup5controlPose1 = new Pose(50.03193146417448, 20.93847352024924);
    private final Pose score5Pose = new Pose(63.87741765734492, 99.82890011629802, Math.toRadians(-45));
